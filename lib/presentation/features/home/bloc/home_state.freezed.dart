...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? age, AgeValidationStatus validationStatus});
}
...
class _$_HomeState implements _HomeState {
  const _$_HomeState({required this.age, required this.validationStatus});
  ...
  @override
  String toString() {
    return 'HomeState(age: $age, validationStatus: $validationStatus)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, age, validationStatus);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      ...
      required final AgeValidationStatus validationStatus}) = _$_HomeState;
